...
static int seyrusefer_set_state_restart_actual (struct seyrusefer *seyrusefer)
{
        seyrusefer_errorf("entered in restart state, restarting...");
...
static int seyrusefer_set_state (struct seyrusefer *seyrusefer, int state)
{
        ...
        } else if (seyrusefer->state == SEYRUSEFER_STATE_RESTART) {
...
struct seyrusefer * seyrusefer_create (struct seyrusefer_init_options *options)
{
        ...
        seyrusefer->settings.modes[SEYRUSEFER_SETTINGS_MODE_1].buttons[SEYRUSEFER_SETTINGS_BUTTON_3].key = SEYRUSEFER_HID_KEY_C;
        ...
        seyrusefer->settings.modes[SEYRUSEFER_SETTINGS_MODE_3].buttons[SEYRUSEFER_SETTINGS_BUTTON_1].key = SEYRUSEFER_HID_CONSUMER_VOLUME_UP;
        seyrusefer->settings.modes[SEYRUSEFER_SETTINGS_MODE_3].buttons[SEYRUSEFER_SETTINGS_BUTTON_2].key = SEYRUSEFER_HID_CONSUMER_VOLUME_UP;
        seyrusefer->settings.modes[SEYRUSEFER_SETTINGS_MODE_3].buttons[SEYRUSEFER_SETTINGS_BUTTON_3].key = SEYRUSEFER_HID_CONSUMER_VOLUME_DOWN;
        seyrusefer->settings.modes[SEYRUSEFER_SETTINGS_MODE_3].buttons[SEYRUSEFER_SETTINGS_BUTTON_4].key = SEYRUSEFER_HID_CONSUMER_SCAN_NEXT_TRK;
        seyrusefer->settings.modes[SEYRUSEFER_SETTINGS_MODE_3].buttons[SEYRUSEFER_SETTINGS_BUTTON_5].key = SEYRUSEFER_HID_CONSUMER_SCAN_PREV_TRK;
...
int seyrusefer_process (struct seyrusefer *seyrusefer)
{
        ...
        if (seyrusefer->state == SEYRUSEFER_STATE_RUNNING) {
                ...
                if (seyrusefer->buttons == (SEYRUSEFER_PLATFORM_BUTTON_1 | SEYRUSEFER_PLATFORM_BUTTON_4)) {
                        ...
                        if (now < seyrusefer->wifi_restart_buttons_tsms ||
                            now - seyrusefer->wifi_restart_buttons_tsms >= seyrusefer->wifi_restart_buttons_dur * 1000) {
                                seyrusefer_set_state(seyrusefer, SEYRUSEFER_STATE_RESTART);
                        }
                } else {
                        seyrusefer->wifi_restart_buttons_tsms = 0;
                }
